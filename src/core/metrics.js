...
if (cluster.isMaster) {
    ...
    prom.collectDefaultMetrics({ register: cmRegister, prefix: 'rnet_cm_' });
	server.listen(3001);
} else {
    ...
    const musicModuleMetrics = [
        new prom.Counter({
            name: 'rnet_app_music_total_user_listen_time',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_total_playing_time',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_song_ends',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_partial_song_ends',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_unique_session_joins',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_disconnects',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_joins',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_leaves',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_plays',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_search',
            help: 'Music module metrics',
        }),
        new prom.Counter({
            name: 'rnet_app_music_skips',
            help: 'Music module metrics',
        }),
        new prom.Summary({
            name: 'rnet_app_music_user_session_summary',
            help: 'Music module metrics',
        }),
        new prom.Summary({
            name: 'rnet_app_music_session_summary',
            help: 'Music module metrics',
        }),
    ];
}
