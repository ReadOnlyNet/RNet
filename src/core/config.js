...
const config = {
	...
	contributors: [
		{ id: '77205340050956288', name: 'Carti [John]#0053', title: 'RNet Overseer', desc: 'Community Overseer.' },
	...
	pkg: pkg,
	rnetGuild: getenv('RNET_GUILD', '538530739017220107'),
	statsGuild: getenv('STATS_GUILD', '301786438083805184'),
	guildLog: '918090297894899722',
	largeGuildLog: '918090364475306004',
	testGuilds: [
		'155149443606380545',
		'538530739017220107',
		'117093893345902593',
		...
		'213000764048670722',
		'255388732746629120',
		'301786438083805184', // RNet Testing
	],
	betaGuilds: [],
	...
	statsdPrefix: getenv('STATSD_PREFIX', 'rnet.prod.'),
};
...
config.webhook = {
	host: getenv('WEBHOOK_HOST', 'http://localhost.com'),
...
config.carbon = {
	...
	info: 'https://www.carbonitex.net/discord/api/bot/info?id=550869101170655233',
};
...
config.dbots = {
	...
	url: 'https://bots.discord.pw/api/bots/550869101170655233/stats',
};
