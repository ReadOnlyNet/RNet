...
declare module RNet {
	...
	export class RNet {
		...
		public readonly config: RNetConfig;
	...
	export class Base {
		...
		public readonly statsd: any;
		public readonly utils: Utils;
		constructor(rnet: RNet, guild?: eris.Guild);
