...
class Uptime extends Command {
	...
	execute({ message }) {
		...
		const embed = {
			...
			footer: {
				text: `PID ${process.pid} | ${this.config.stateName} | Cluster ${this.rnet.clientOptions.clusterId.toString()} | Shard ${message.channel.guild.shard.id} | Last started on ${started}`,
			},
		};
