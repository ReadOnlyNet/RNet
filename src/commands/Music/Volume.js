...
class Volume extends Command {
	...
	execute({ message, args, guildConfig }) {
		if (!guildConfig.isPremium) {
			const msgArray = [
				`:warning: In order to provide significantly better music performance, the volume command is disabled for public RNet.`,
		...
		let music = this.rnet.modules.get('Music');
